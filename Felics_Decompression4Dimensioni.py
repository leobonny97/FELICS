                                        ...
                                        if not secondo2:
                                            ...
                                            if not secondo3:
                                                ...
                                                if not secondo4:
                                                    ...
                                                    array_immagine = np.zeros((x, y, 4), dtype=int)
                                                    #num_bin = abc.dec_bin(ord(primo1), 8)
                                                    array_immagine[0][0] = (ord(primo1), ord(primo2), ord(primo3), ord(primo4))
                                                    # print(ord(primo1))
                                                    # print(num_bin)
                                                    #num_bin = abc.dec_bin(ord(secondo1), 8)
                                                    array_immagine[0][1] = (ord(secondo1), ord(secondo2), ord(secondo3), ord(secondo4))
                                                    #print(ord(secondo1))
                                                    #print(num_bin)
        ...
        if (indice > 1):
            for count_comp in range(0, 4):
                ...
                if(count_comp == 0):
                    ...
                    result3, code = left_center_rightDec(high, low, code)
                    array_immagine[riga, colonna] = (result0, result1, result2, result3)
        else:
            indice = indice + 1
