...
def searchContesti(high, low):
    ...
    if pos != -1:                                   # è stato trovato il contesto cercato
        array_di_valori1 = arr_contesti[pos + 1]    #recupero i valori
...
def aggiornaContesto_dec(high, low, p, pos):
